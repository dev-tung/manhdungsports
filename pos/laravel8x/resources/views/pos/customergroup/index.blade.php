...
@section('Main')
        ...
        <div class="MainContent">
            ...
            <div class="List">
                @foreach( $customergroup as $customergroup )
                    <a class="ListItem" href="{{route('customergroup.edit', ['screen'=>'pos', 'customergroup_id' => $customergroup->customergroup_id])}}">
    ...
    <div class="Float Float_BottomRight">
        <a class="Btn Btn_Success" href="{{route('customergroup.add', ['screen'=>'pos'])}}">
