        ...
        <div class="MainContent">
            <div class="ListSearch">
                <form action="{{route('string.index')}}" class="ListSearchForm">
                    <input class="ListSearchFormInput" type="text" name="string_name" placeholder="Tìm kiếm danh mục sản phẩm ..." value="{{ request()->string_name }}">
            ...
            <div class="ListSearchTotal">
                <span class="ListSearchTotalItem">{{ $string->count() }} danh mục</span>
            </div>
