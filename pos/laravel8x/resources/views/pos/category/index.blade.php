...
@section('main')
        ...
        <div class="MainContent">
            <div class="ListSearch">
                <form action="{{route('category.index')}}" class="ListSearchForm">
                    <input class="ListSearchFormInput" type="text" name="category_name" placeholder="Tìm kiếm danh mục sản phẩm ..." value="{{ request()->category_name }}">
            ...
            <div class="ListSearchTotal">
                <span class="ListSearchTotalItem">{{ $categories->count() }} danh mục</span>
            </div>

            <div class="List">
                @foreach( $categories as $category )
                    <a class="ListItem" href="{{route('category.edit', $category->category_id)}}">
    ...
    <div class="Float Float_BottomRight">
        <a class="Btn Btn_Success" href="{{route('category.add')}}">
