                            ...
                            <ul class="FooterList">
                                @if( !empty( $productypes ) )
                                    @foreach( $productypes as $key => $item )
                                        <li class="FooterListItem"><a class="FooterLinkItem" href="{{ route('web.product.index', ['productype_code' => $key]) }}">{{$item}}</a></li>
                                    @endforeach  
                                @endif
                            </ul>
                        </div>
                ...
                <div class="ModalBody">
                    <div class="ModalWidth">
                        <ul class="ModalList">
                            @if( !empty( $productypes ) )
                                @foreach( $productypes as $key => $item )
                                    <li class="ModalListItem"><a href="{{ route('web.product.index', ['productype_code' => $key]) }}" class="ModalItemLink">{{$item}}</a></li>
                                @endforeach  
                            @endif
                        </ul>
                    </div>
                        ...
                        <ul class="ModalList">
                            <li class="ModalListItem">
                                <a href="" class="ModalItemLink ModalItemLink_Cart">
                                    <img class="ModalCartDelIcon" title="Xoá sản phẩm" src="{{ asset('web/img/icon/delete.png')}}" alt="">
                                    <img class="ModalCartThumnail" src="{{ asset('web/img/logo.png')}}" alt="">
